...
Route::get('/demand-forecast', [App\Http\Controllers\DemandForecastController::class, 'index'])->name('demand-forecast.index');
Route::post('/demand-forecast/process', [App\Http\Controllers\DemandForecastController::class, 'process'])->name('demand-forecast.process');
Route::get('/demand-forecast/results', [App\Http\Controllers\DemandForecastController::class, 'results'])->name('demand-forecast.results');
Route::get('/demand-forecast/price-chart', [App\Http\Controllers\DemandForecastController::class, 'priceChart'])->name('demand-forecast.price-chart');
Route::get('/demand-forecast/daily-analysis', [App\Http\Controllers\DemandForecastController::class, 'dailyAnalysis'])->name('demand-forecast.daily-analysis');
Route::get('/demand-forecast/all-sales', [App\Http\Controllers\DemandForecastController::class, 'allSales'])->name('demand-forecast.all-sales');
Route::get('/demand-forecast/test', [App\Http\Controllers\DemandForecastController::class, 'test'])->name('demand-forecast.test');
...
Route::prefix('auth')->middleware(['web'])->group(function () {
    ...
    Route::prefix('vendor')->name('vendor.')->group(function () {
        ...
        Route::post('/abn-validate', [\App\Http\Controllers\Api\ABNLookupController::class, 'validate'])->name('abn-validate');
    });
...
Route::prefix('cart')->name('cart.')->group(function () {
    ...
    Route::put('/items/{item}', [\App\Http\Controllers\CartController::class, 'update'])->name('update');
    ...
    Route::get('/contents', [\App\Http\Controllers\CartController::class, 'contents'])->name('contents');
    Route::get('/checkout', [\App\Http\Controllers\CartController::class, 'checkout'])->name('checkout')->middleware('auth:buyer');
    Route::post('/items/{item}/save-later', [\App\Http\Controllers\CartController::class, 'saveForLater'])->name('save-later');
});
...
Route::middleware(['web', 'auth:buyer'])->prefix('buyer')->name('buyer.')->group(function () {
    ...
    Route::get('/profile', function() { return view('buyer.profile'); })->name('profile');
    Route::get('/orders', function() { return view('buyer.orders.index'); })->name('orders');
...
// Additional profile route without .index
Route::middleware(['web', 'auth:buyer'])->group(function () {
